...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void draw(Graphics g) {
        ...
        if (running) {
            ...
            g.drawString("Pontuação: " + applesEaten,
                    (SCREEN_WIDTH - metrics.stringWidth("Pontuação: " + applesEaten)) / 2, g.getFont().getSize());
        } else {
            gameOver(g);
        }
    ...
    public void gameOver(Graphics g) {
        ...
        g.drawString("Pontuação: " + applesEaten,
                (SCREEN_WIDTH - metrics1.stringWidth("Pontuação: " + applesEaten)) / 2, g.getFont().getSize());
        // Game Over text
        g.setColor(Color.red);
        g.setFont(new Font("Ink Free", Font.BOLD, 75));
        FontMetrics metrics2 = getFontMetrics(g.getFont());
        g.drawString("Fim de Jobo", (SCREEN_WIDTH - metrics2.stringWidth("Fim de Jogo")) / 2, SCREEN_HEIGHT / 2);
    }
